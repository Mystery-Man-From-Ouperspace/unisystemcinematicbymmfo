export class unisystemActor extends Actor {
    ...
    _prepareCharacterData(actorData) {
      ...
      let buffychaTypeLabel = data.buffycharacterTypes[data.buffycharacterType]
      let angelchaTypeLabel = data.angelcharacterTypes[data.angelcharacterType]
      let armyofdarknesschaTypeLabel = data.armyofdarknesscharacterTypes[data.armyofdarknesscharacterType]
      let cityofheroeschaTypeLabel = data.cityofheroescharacterTypes[data.cityofheroescharacterType]
      let ghostsofalbionchaTypeLabel = data.ghostsofalbioncharacterTypes[data.ghostsofalbioncharacterType]
      let eldritchskieschaTypeLabel = data.eldritchskiescharacterTypes[data.eldritchskiescharacterType]
      if(buffychaTypeLabel != undefined) {
        data.buffycharacterTypeValues[buffychaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.buffycharacterTypeValues[buffychaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.buffycharacterTypeValues[buffychaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.buffycharacterTypeValues[buffychaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.buffycharacterTypeValues[buffychaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
      if(angelchaTypeLabel != undefined) {
        data.angelcharacterTypeValues[angelchaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.angelcharacterTypeValues[angelchaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.angelcharacterTypeValues[angelchaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.angelcharacterTypeValues[angelchaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.angelcharacterTypeValues[angelchaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
      if(armyofdarknesschaTypeLabel != undefined) {
      ...
      if(cityofheroeschaTypeLabel != undefined) {
        data.cityofheroescharacterTypeValues[cityofheroeschaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.cityofheroescharacterTypeValues[cityofheroeschaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.cityofheroescharacterTypeValues[cityofheroeschaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.cityofheroescharacterTypeValues[cityofheroeschaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.cityofheroescharacterTypeValues[cityofheroeschaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
      if(ghostsofalbionchaTypeLabel != undefined) {
        data.ghostsofalbioncharacterTypeValues[ghostsofalbionchaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.ghostsofalbioncharacterTypeValues[ghostsofalbionchaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.ghostsofalbioncharacterTypeValues[ghostsofalbionchaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.ghostsofalbioncharacterTypeValues[ghostsofalbionchaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.ghostsofalbioncharacterTypeValues[ghostsofalbionchaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
      if(eldritchskieschaTypeLabel != undefined) {
        data.eldritchskiescharacterTypeValues[eldritchskieschaTypeLabel].attributePoints.value = this._calculateAttributePoints(data)
        data.eldritchskiescharacterTypeValues[eldritchskieschaTypeLabel].qualityPoints.value = this._calculateQualityPoints(data)
        data.eldritchskiescharacterTypeValues[eldritchskieschaTypeLabel].drawbackPoints.value = this._calculateDrawbackPoints(data)
        data.eldritchskiescharacterTypeValues[eldritchskieschaTypeLabel].skillPoints.value = this._calculateSkillPoints(data)
        data.eldritchskiescharacterTypeValues[eldritchskieschaTypeLabel].metaphysicsPoints.value = this._calculateMetaphysicsPoints(data)
      }
